...
public class AuthService implements AuthUseCase {
    ...
    public AuthRes.TokenDto login(AuthReq.Login request) {
        ...
        String accessToken = jwtProvider.generateAccessToken(user.getLoginId(), user.getRole().getKey());
    ...
    public AuthRes.TokenDto refresh(AuthReq.Refresh request) {
        ...
        String loginId = jwtProvider.getAuthentication(tokenString).getName();
        ...
        String newAccessToken = jwtProvider.generateAccessToken(user.getLoginId(), user.getRole().getKey());
