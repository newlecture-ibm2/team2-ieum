...
| 9 | **Inquiry** | 문의하기 | id, user_id(FK), title, content, status(PENDING/ANSWERED), created_at |
...
erDiagram
    ...
    INQUIRY ||--o{ INQUIRY_ANSWER : "has answer"
    USER }o--o{ INQUIRY_ANSWER : "admin answers"
...
- User `1:N` Inquiry — 한 사용자가 여러 문의 작성
- Inquiry `1:N` InquiryAnswer — 하나의 문의에 관리자 답변 (보통 1개, 추가 답변 가능)
