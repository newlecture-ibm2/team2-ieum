...
export default function PrivacyContent() {
  return (
    <div className={styles.legalContent}>
      ...
      <p>
        ① 회원 탈퇴 요청 시 <strong>30일간의 유예 기간</strong> 동안 개인정보를 보관하며, 유예 기간 내 재로그인 시 계정이 복구됩니다.
        유예 기간 경과 후 복구 불가능한 방법으로 영구 파기합니다.<br />
        ② 단, 관련 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관합니다.<br />
