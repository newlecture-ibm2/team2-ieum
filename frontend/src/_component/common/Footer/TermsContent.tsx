  ...
  return (
    <div className={styles.legalContent}>
      ...
      <p>
        ...
        ② 회원은 언제든지 서비스 내 마이페이지 설정을 통해 탈퇴를 요청할 수 있습니다.<br />
        ③ 탈퇴 요청 시 계정은 즉시 삭제되지 않으며, <strong>30일간의 유예 기간</strong>이 적용됩니다.
        유예 기간 중 기존 아이디로 다시 로그인하면 계정이 자동으로 복구됩니다.<br />
        ④ 유예 기간(30일)이 경과하면 모든 개인정보 및 데이터는 복구 불가능하게 영구 삭제됩니다.
      </p>
      ...
      <p>
        ...
        ③ 신고 처리(경고) 누적 <strong>3회까지는 경고</strong> 조치하며, <strong>4회째 신고가 확인될 경우</strong> 관리자는 해당 회원의 서비스 이용을 <strong>7일간 정지</strong>할 수 있습니다.<br />
        ④ 이용 정지 기간 중 해당 회원은 로그인은 가능하나, 게시글 작성, 댓글 작성, 리뷰 작성 등 <strong>쓰기 기능이 제한</strong>됩니다.<br />
        ⑤ 이용 정지 이후에도 반복적인 위반이 확인될 경우, 관리자는 <strong>강제 탈퇴(영구 삭제)</strong> 등 추가 조치를 취할 수 있습니다.
      </p>
